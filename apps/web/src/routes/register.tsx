          ...
          >
            <div className="card-elevated" style={{ padding: 36 }}>
              <div style={{ textAlign: 'center', marginBottom: 28 }}>
                ...
                <Text style={{ color: 'var(--color-text-muted)' }}>Create your account to start tracking audit logs</Text>
              </div>
              ...
              <Form layout="vertical">
                ...
                <Form.Item label={<span style={{ color: 'var(--color-text-secondary)', fontWeight: 500 }}>Confirm Password</span>} required>
                  <Input.Password placeholder="••••••••" size="large" />
                </Form.Item>
